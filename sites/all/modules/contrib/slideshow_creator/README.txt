...
3* The CCK field is known not to work in the Drupal 7 version. Since
   this is not the critical feature of the module, it is uncertain
   at present if this will be fixed. If you need it, you are welcome
   to have a go getting it up and running!
